...
class Entity:
    ...
    def camera(self) -> PositionCamera:
        ...
        '''
        return PositionCamera(int(self.position.x -GameSettings.SCREEN_WIDTH // 2 + GameSettings.TILE_SIZE // 2 ), int(self.position.y - GameSettings.SCREEN_HEIGHT // 2 + GameSettings.TILE_SIZE // 2))
